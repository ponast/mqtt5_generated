...
#include "mqtt5/field/PubcompProperties.h"
#include "mqtt5/field/PubcompReasonCode.h"
...
struct PubcompFields
{
    ...
    public:
        ...
        {
            return mqtt5::message::PubcompFieldsCommon::PacketIdCommon::name();
        }
    };

    /// @brief Definition of <b>"Reason code"</b> field.
    using ReasonCode =
        mqtt5::field::PubcompReasonCode<
            TOpt
        >;

    /// @brief Definition of <b>"Properties"</b> field.
    using Properties =
        mqtt5::field::PubcompProperties<
            TOpt
        >;
