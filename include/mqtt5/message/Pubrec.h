...
#include "mqtt5/field/PubrecProperties.h"
#include "mqtt5/field/PubrecReasonCode.h"
...
struct PubrecFields
{
    ...
    public:
        ...
        {
            return mqtt5::message::PubrecFieldsCommon::PacketIdCommon::name();
        }
