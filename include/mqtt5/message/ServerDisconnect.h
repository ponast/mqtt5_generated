...
/// @file
/// @brief Contains definition of <b>"SERVER DISCONNECT"</b> message and its fields.
...
struct ServerDisconnectFields
{
    ...
    public:
        ...
        {
            return mqtt5::message::ServerDisconnectFieldsCommon::PropertiesCommon::name();
        }
    };
...
/// @brief Definition of <b>"SERVER DISCONNECT"</b> message class.
/// @details
