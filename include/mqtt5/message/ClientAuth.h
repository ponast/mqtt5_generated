...
/// @file
/// @brief Contains definition of <b>"CLIENT AUTH"</b> message and its fields.
...
struct ClientAuthFields
{
    ...
    public:
        ...
        {
            return mqtt5::message::ClientAuthFieldsCommon::PropertiesCommon::name();
        }
    };
...
/// @brief Definition of <b>"CLIENT AUTH"</b> message class.
/// @details
