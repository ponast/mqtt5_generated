...
///    @ref mqtt5::field::PubrecReasonCode field.
...
struct PubrecReasonCodeCommon
{
    ...
    /// @brief Name of the @ref mqtt5::field::PubrecReasonCode field.
...
/// @brief Values enumerator for
///     @ref mqtt5::field::PubrecReasonCode field.
using PubrecReasonCodeVal = PubrecReasonCodeCommon::ValueType;
