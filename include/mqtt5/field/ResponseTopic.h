...
struct ResponseTopicMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::ResponseTopicMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::ResponseTopicMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::ResponseTopicMembersCommon::ValueCommon::name();
        }
...
class ResponseTopic : public
    comms::field::Bundle<
        ...
        typename ResponseTopicMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::ResponseTopicMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::ResponseTopicMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::ResponseTopicCommon::name();
    }
