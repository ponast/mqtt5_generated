...
struct SubscriptionIdMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::SubscriptionIdMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::SubscriptionIdMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::SubscriptionIdMembersCommon::ValueCommon::name();
        }
...
class SubscriptionId : public
    comms::field::Bundle<
        ...
        typename SubscriptionIdMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::SubscriptionIdMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::SubscriptionIdMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::SubscriptionIdCommon::name();
    }
