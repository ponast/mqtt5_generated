...
///    @ref mqtt5::field::ClientAuthReasonCode field.
...
///     @ref mqtt5::field::ClientAuthReasonCode field.
struct ClientAuthReasonCodeCommon
{
    ...
    enum class ValueType : std::uint8_t
    {
        ...
        FirstValue = 24, ///< First defined value.
    ...
    /// @brief Name of the @ref mqtt5::field::ClientAuthReasonCode field.
    static const char* name()
    {
        return "Client Reason Code";
    }
...
/// @brief Values enumerator for
///     @ref mqtt5::field::ClientAuthReasonCode field.
using ClientAuthReasonCodeVal = ClientAuthReasonCodeCommon::ValueType;
