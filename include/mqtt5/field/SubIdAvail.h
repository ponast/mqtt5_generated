...
struct SubIdAvailMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::SubIdAvailMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::SubIdAvailMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::SubIdAvailMembersCommon::ValueCommon::name();
        }
...
class SubIdAvail : public
    comms::field::Bundle<
        ...
        typename SubIdAvailMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::SubIdAvailMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::SubIdAvailMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::SubIdAvailCommon::name();
    }
