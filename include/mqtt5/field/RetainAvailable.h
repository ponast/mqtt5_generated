...
struct RetainAvailableMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::RetainAvailableMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::RetainAvailableMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::RetainAvailableMembersCommon::ValueCommon::name();
        }
...
class RetainAvailable : public
    comms::field::Bundle<
        ...
        typename RetainAvailableMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::RetainAvailableMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::RetainAvailableMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::RetainAvailableCommon::name();
    }
