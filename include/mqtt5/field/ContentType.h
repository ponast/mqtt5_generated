...
struct ContentTypeMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::ContentTypeMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::ContentTypeMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::ContentTypeMembersCommon::ValueCommon::name();
        }
...
class ContentType : public
    comms::field::Bundle<
        ...
        typename ContentTypeMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::ContentTypeMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::ContentTypeMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::ContentTypeCommon::name();
    }
