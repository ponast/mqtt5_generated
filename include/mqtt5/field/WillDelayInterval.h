...
struct WillDelayIntervalMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::WillDelayIntervalMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::WillDelayIntervalMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return mqtt5::field::WillDelayIntervalMembersCommon::ValueCommon::hasSpecials();
        }
        ...
        static const char* name()
        {
            return mqtt5::field::WillDelayIntervalMembersCommon::ValueCommon::name();
        }
...
class WillDelayInterval : public
    comms::field::Bundle<
        mqtt5::field::FieldBase<>,
        typename WillDelayIntervalMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::WillDelayIntervalMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::WillDelayIntervalMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::WillDelayIntervalCommon::name();
    }
