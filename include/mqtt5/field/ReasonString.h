...
///     @ref ReasonString field.
/// @tparam TOpt Protocol options.
template <typename TOpt = mqtt5::options::DefaultOptions>
struct ReasonStringMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::ReasonStringMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::ReasonStringMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::ReasonStringMembersCommon::ValueCommon::name();
        }
...
class ReasonString : public
    comms::field::Bundle<
        mqtt5::field::FieldBase<>,
        typename ReasonStringMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::ReasonStringMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::ReasonStringMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::ReasonStringCommon::name();
    }
