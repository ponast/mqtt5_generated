...
struct AuthMethodMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::AuthMethodMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::AuthMethodMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::AuthMethodMembersCommon::ValueCommon::name();
        }
...
class AuthMethod : public
    comms::field::Bundle<
        ...
        typename AuthMethodMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::AuthMethodMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::AuthMethodMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::AuthMethodCommon::name();
    }
