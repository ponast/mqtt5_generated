...
///     @ref PropertyWildcardSubAvail field.
/// @tparam TOpt Protocol options.
template <typename TOpt = mqtt5::options::DefaultOptions>
struct PropertyWildcardSubAvailMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::PropertyWildcardSubAvailMembersCommon::IdCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return mqtt5::field::PropertyWildcardSubAvailMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::PropertyWildcardSubAvailMembersCommon::ValueCommon::name();
        }
    };
...
class PropertyWildcardSubAvail : public
    comms::field::Bundle<
        mqtt5::field::FieldBase<>,
        typename PropertyWildcardSubAvailMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::PropertyWildcardSubAvailMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::PropertyWildcardSubAvailMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::PropertyWildcardSubAvailCommon::name();
    }
};
