...
///    @ref mqtt5::field::PubrelReasonCode field.
...
struct PubrelReasonCodeCommon
{
    ...
    /// @brief Name of the @ref mqtt5::field::PubrelReasonCode field.
...
/// @brief Values enumerator for
///     @ref mqtt5::field::PubrelReasonCode field.
using PubrelReasonCodeVal = PubrelReasonCodeCommon::ValueType;
