...
struct SharedSubAvailMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::SharedSubAvailMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::SharedSubAvailMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::SharedSubAvailMembersCommon::ValueCommon::name();
        }
...
class SharedSubAvail : public
    comms::field::Bundle<
        ...
        typename SharedSubAvailMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::SharedSubAvailMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::SharedSubAvailMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::SharedSubAvailCommon::name();
    }
