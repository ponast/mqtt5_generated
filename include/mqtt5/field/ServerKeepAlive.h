...
struct ServerKeepAliveMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::ServerKeepAliveMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::ServerKeepAliveMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return mqtt5::field::ServerKeepAliveMembersCommon::ValueCommon::hasSpecials();
        }
        ...
        static const char* name()
        {
            return mqtt5::field::ServerKeepAliveMembersCommon::ValueCommon::name();
        }
...
class ServerKeepAlive : public
    comms::field::Bundle<
        mqtt5::field::FieldBase<>,
        typename ServerKeepAliveMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::ServerKeepAliveMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::ServerKeepAliveMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::ServerKeepAliveCommon::name();
    }
