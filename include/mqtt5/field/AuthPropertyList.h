...
struct AuthPropertyListMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::AuthPropertyListMembersCommon::LengthCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::AuthPropertyListMembersCommon::LengthCommon::name();
        }
...
public:
    ...
    static const char* name()
    {
        return mqtt5::field::AuthPropertyListCommon::name();
    }
