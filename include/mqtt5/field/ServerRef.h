...
struct ServerRefMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::ServerRefMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::ServerRefMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return mqtt5::field::ServerRefMembersCommon::ValueCommon::name();
        }
...
class ServerRef : public
    comms::field::Bundle<
        ...
        typename ServerRefMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::ServerRefMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::ServerRefMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::ServerRefCommon::name();
    }
