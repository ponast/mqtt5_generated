...
struct TopicAliasMaxMembers
{
    ...
    public:
        ...
        {
            return mqtt5::field::TopicAliasMaxMembersCommon::IdCommon::hasSpecials();
        }
        ...
        {
            return mqtt5::field::TopicAliasMaxMembersCommon::IdCommon::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return mqtt5::field::TopicAliasMaxMembersCommon::ValueCommon::hasSpecials();
        }
        ...
        static const char* name()
        {
            return mqtt5::field::TopicAliasMaxMembersCommon::ValueCommon::name();
        }
...
class TopicAliasMax : public
    comms::field::Bundle<
        mqtt5::field::FieldBase<>,
        typename TopicAliasMaxMembers<TOpt>::All,
        TExtraOpts...
    >
{
    using Base =
...
public:
    ...
    ///         for mqtt5::field::TopicAliasMaxMembers::Id member field.
    ///     @li @b FieldIdx_value index, @b Field_value type and @b field_value() access function -
    ///         for mqtt5::field::TopicAliasMaxMembers::Value member field.
    ...
    static const char* name()
    {
        return mqtt5::field::TopicAliasMaxCommon::name();
    }
